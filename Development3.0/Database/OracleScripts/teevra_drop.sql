...
ALTER TABLE activity
	DROP CONSTRAINT activity_activity_name_key CASCADE 
/
ALTER TABLE component
	DROP CONSTRAINT component_comp_type_check CASCADE 
/

ALTER TABLE component
	DROP CONSTRAINT component_comp_status_check CASCADE 
/
ALTER TABLE component
	DROP CONSTRAINT comp_name_comp_ver_id_key CASCADE 
/
ALTER TABLE datasource_config
	DROP CONSTRAINT ds_config_ds_name_key CASCADE 
/
ALTER TABLE message_schema
	DROP CONSTRAINT msg_schema_schema_name_key CASCADE 
/
ALTER TABLE message_schema_attribute
	DROP CONSTRAINT msg_schm_atb_schm_attr_reln CASCADE 
/
ALTER TABLE message_schema_attribute
	DROP CONSTRAINT mesg_schm_atb_schm_attr_key CASCADE 
/
ALTER TABLE process
	DROP CONSTRAINT process_prcs_status_check CASCADE 
/
ALTER TABLE process_component
	DROP CONSTRAINT prcs_comp_prcs_comp_id_key CASCADE 
/
...
/
ALTER TABLE process_runtime
	DROP CONSTRAINT process_runtime_prcs_id_key CASCADE 
/
ALTER TABLE process_runtime_eventlog
	DROP CONSTRAINT procs_rt_elog_prcs_evnt_check CASCADE 
/
ALTER TABLE process_server
	DROP CONSTRAINT process_server_prcs_id_key CASCADE 
/
ALTER TABLE refdata_config
	DROP CONSTRAINT refdat_config_refdat_name_key CASCADE 
/
ALTER TABLE roles
	DROP CONSTRAINT roles_role_name_key CASCADE 
/
ALTER TABLE server_configuration
	DROP CONSTRAINT serv_config_serv_name_key CASCADE 
/
ALTER TABLE state_machine
	DROP CONSTRAINT st_machine_st_machine_status CASCADE 
/
ALTER TABLE users
	DROP CONSTRAINT users_status_check CASCADE 
/
ALTER TABLE users
	DROP CONSTRAINT users_user_name_key CASCADE 
/
ALTER TABLE role_activity
	DROP CONSTRAINT role_activity_activity_id_fkey CASCADE 
/
ALTER TABLE component_configuration
	DROP CONSTRAINT comp_config_comp_id_fkey CASCADE 
/
ALTER TABLE component_template
	DROP CONSTRAINT comp_temp_comp_id_fkey CASCADE 
/
ALTER TABLE refdata_config
	DROP CONSTRAINT refdata_config_ds_id_fkey CASCADE 
/
ALTER TABLE message_schema_attribute
	DROP CONSTRAINT msg_schm_attrib_schm_id_fkey CASCADE 
/
ALTER TABLE message_schema_attribute
	DROP CONSTRAINT msg_schm_schm_atb_type_fkey CASCADE 
/
ALTER TABLE message_schema_raw
	DROP CONSTRAINT msg_schm_raw_schm_id_fkey CASCADE 
/
ALTER TABLE process_schedule
	DROP CONSTRAINT process_schd_prcs_id_fkey CASCADE 
/
ALTER TABLE process_server
	DROP CONSTRAINT process_server_prcs_id_fkey CASCADE 
/
ALTER TABLE process_service_configuration
	DROP CONSTRAINT prcs_ser_config_prcs_id_fkey CASCADE 
/
ALTER TABLE role_activity
	DROP CONSTRAINT role_activity_role_id_fkey CASCADE 
/
ALTER TABLE user_role
	DROP CONSTRAINT user_role_role_id_fkey CASCADE 
/
ALTER TABLE process_server
	DROP CONSTRAINT process_server_server_id_fkey CASCADE 
/
ALTER TABLE user_role
	DROP CONSTRAINT user_role_user_id_fkey CASCADE 
/
ALTER TABLE method 
...
/
DROP SEQUENCE component_eventlog_id_seq
/
