...
/**
 * An implementation of LogPersistor. It logs the events from temporary Database
 * system to a relational database
 */
public class DBLogPersistor implements EventLogPersistor {

	private static final Logger logger = LoggerFactory
			.getLogger(DBLogPersistor.class);

	private static BundleContext context;

	public DBLogPersistor(BundleContext bundleContext) throws FusionException {
