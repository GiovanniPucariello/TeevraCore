 ...
 * 
 */
public class MarkForDeletionTask implements Runnable {

	private static Logger logger = LoggerFactory
			.getLogger(MarkForDeletionTask.class);
	/**
	 * recoverable data
	 */
	 ...
	 * @param recoverable
	 */
	public MarkForDeletionTask(Recoverable recoverable,
	...
	public void run() {
		...
		try {
			this.processRecoveryContext.markMessageProcessed(recoverable);
		} catch (Exception e) {
