 ...
 * All rights reserved.
 * 
 * $Id: OnCompMessageReceiveProcessor.java
 * $Revision: 
 * $Author: viswanathp
 ...
 * 
 */
public class OnCompMessageReceiveProcessor implements Processor {
	/**
	 * logger.
	 */
	private static Logger logger = LoggerFactory
			.getLogger(OnCompMessageReceiveProcessor.class);
	 ...
	 */
	public OnCompMessageReceiveProcessor(ProcessContext processContext,
			String endpointId) {
	...
	public void process(Exchange exchange) throws Exception {
		...
		logBean.setLogMessage("Message Received ");
