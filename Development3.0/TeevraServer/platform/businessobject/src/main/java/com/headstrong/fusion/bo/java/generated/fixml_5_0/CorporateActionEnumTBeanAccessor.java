...
public class CorporateActionEnumTBeanAccessor implements BeanAccessor<CorporateActionEnumT> {
	
	private CorporateActionEnumT bean;
	...
	@Override
	public void setTarget(CorporateActionEnumT obj) {
		this.bean = obj; 
	}
