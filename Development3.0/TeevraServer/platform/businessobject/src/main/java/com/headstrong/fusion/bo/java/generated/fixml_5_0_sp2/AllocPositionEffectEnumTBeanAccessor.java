...
public class AllocPositionEffectEnumTBeanAccessor implements BeanAccessor<AllocPositionEffectEnumT> {
	
	private AllocPositionEffectEnumT bean;
	...
	@Override
	public void setTarget(AllocPositionEffectEnumT obj) {
		this.bean = obj; 
	}
