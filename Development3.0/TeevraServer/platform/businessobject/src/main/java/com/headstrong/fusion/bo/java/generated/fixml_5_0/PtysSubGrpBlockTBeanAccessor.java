...
public class PtysSubGrpBlockTBeanAccessor implements BeanAccessor<PtysSubGrpBlockT> {
	
	private PtysSubGrpBlockT bean;
	...
	@Override
	public void setTarget(PtysSubGrpBlockT obj) {
		this.bean = obj; 
	}
