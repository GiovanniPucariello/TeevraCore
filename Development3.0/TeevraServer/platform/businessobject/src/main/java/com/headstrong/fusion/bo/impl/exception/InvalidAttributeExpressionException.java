 ...
 */
public class InvalidAttributeExpressionException extends SchemaServiceException {
	 ...
	 * @param bo
	 *            <code>DefaultBusinessObject</code> instance on which this
	 *            attribute was queried
	 */
	public InvalidAttributeExpressionException(String attributeName,
			BusinessObject bo) {
		super(attributeName + " is null or invalid ");
	}
