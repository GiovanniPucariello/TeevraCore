...
import org.fixprotocol.fixml_5_0_sp2.UnderlyingStipulationsBlockT;
...
public class UnderlyingStipulationsBlockTBeanAccessor implements BeanAccessor<UnderlyingStipulationsBlockT> {
	
	private UnderlyingStipulationsBlockT bean;
	...
	@Override
	public void setTarget(UnderlyingStipulationsBlockT obj) {
		this.bean = obj; 
	}
