...
public class SettlMethodEnumTBeanAccessor implements BeanAccessor<SettlMethodEnumT> {
	
	private SettlMethodEnumT bean;
	...
	@Override
	public void setTarget(SettlMethodEnumT obj) {
		this.bean = obj; 
	}
