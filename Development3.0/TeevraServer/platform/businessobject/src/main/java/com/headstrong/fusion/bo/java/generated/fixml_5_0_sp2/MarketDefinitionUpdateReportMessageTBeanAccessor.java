...
import org.fixprotocol.fixml_5_0_sp2.MarketDefinitionUpdateReportMessageT;
...
public class MarketDefinitionUpdateReportMessageTBeanAccessor implements BeanAccessor<MarketDefinitionUpdateReportMessageT> {
	
	private MarketDefinitionUpdateReportMessageT bean;
	
	@Override
	public Object get(String accessPath) throws AttributeNotFoundException {
		 if("mktUpdtActn".equalsIgnoreCase(accessPath)){
			return this.bean.getMktUpdtActn();
		}
		else if("baseTrdgRules".equalsIgnoreCase(accessPath)){
	...
	public void set(String accessPath, Object obj)throws AttributeNotFoundException {
		 if("mktUpdtActn".equalsIgnoreCase(accessPath)){
		    ...
		    this.bean.setMktUpdtActn(SecurityUpdateActionEnumT.valueOf(obj.toString()));
			return;
		}
		else if("baseTrdgRules".equalsIgnoreCase(accessPath)){
	...
	@Override
	public void setTarget(MarketDefinitionUpdateReportMessageT obj) {
		this.bean = obj; 
	}
