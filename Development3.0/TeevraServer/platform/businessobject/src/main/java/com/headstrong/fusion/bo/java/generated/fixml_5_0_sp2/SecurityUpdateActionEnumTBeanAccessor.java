...
public class SecurityUpdateActionEnumTBeanAccessor implements BeanAccessor<SecurityUpdateActionEnumT> {
	
	private SecurityUpdateActionEnumT bean;
	...
	@Override
	public void setTarget(SecurityUpdateActionEnumT obj) {
		this.bean = obj; 
	}
