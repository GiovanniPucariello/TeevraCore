...
import org.fixprotocol.fixml_5_0_sp2.SettlPartiesBlockT;
...
public class SettlPartiesBlockTBeanAccessor implements BeanAccessor<SettlPartiesBlockT> {
	
	private SettlPartiesBlockT bean;
	...
	@Override
	public void setTarget(SettlPartiesBlockT obj) {
		this.bean = obj; 
	}
