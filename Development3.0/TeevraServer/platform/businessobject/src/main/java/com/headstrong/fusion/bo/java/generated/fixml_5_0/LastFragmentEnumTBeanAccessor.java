...
public class LastFragmentEnumTBeanAccessor implements BeanAccessor<LastFragmentEnumT> {
	
	private LastFragmentEnumT bean;
	...
	@Override
	public void setTarget(LastFragmentEnumT obj) {
		this.bean = obj; 
	}
