...
public class StipulationTypeEnumTBeanAccessor implements BeanAccessor<StipulationTypeEnumT> {
	
	private StipulationTypeEnumT bean;
	...
	@Override
	public void setTarget(StipulationTypeEnumT obj) {
		this.bean = obj; 
	}
