...
public class RelatedPartyDetailBlockTBeanAccessor implements BeanAccessor<RelatedPartyDetailBlockT> {
	
	private RelatedPartyDetailBlockT bean;
	...
	@Override
	public void setTarget(RelatedPartyDetailBlockT obj) {
		this.bean = obj; 
	}
