...
public class ExerciseMethodEnumTBeanAccessor implements BeanAccessor<ExerciseMethodEnumT> {
	
	private ExerciseMethodEnumT bean;
	...
	@Override
	public void setTarget(ExerciseMethodEnumT obj) {
		this.bean = obj; 
	}
