...
import org.fixprotocol.fixml_5_0_sp2.PartiesBlockT;
...
public class PartiesBlockTBeanAccessor implements BeanAccessor<PartiesBlockT> {
	
	private PartiesBlockT bean;
	...
	@Override
	public void setTarget(PartiesBlockT obj) {
		this.bean = obj; 
	}
