...
public class AllocRptRptSideGrpBlockTBeanAccessor implements BeanAccessor<AllocRptRptSideGrpBlockT> {
	
	private AllocRptRptSideGrpBlockT bean;
	...
	@Override
	public void setTarget(AllocRptRptSideGrpBlockT obj) {
		this.bean = obj; 
	}
