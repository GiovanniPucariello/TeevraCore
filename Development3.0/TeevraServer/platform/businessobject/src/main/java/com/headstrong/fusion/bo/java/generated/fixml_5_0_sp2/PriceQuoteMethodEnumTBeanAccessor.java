...
public class PriceQuoteMethodEnumTBeanAccessor implements BeanAccessor<PriceQuoteMethodEnumT> {
	
	private PriceQuoteMethodEnumT bean;
	...
	@Override
	public void setTarget(PriceQuoteMethodEnumT obj) {
		this.bean = obj; 
	}
