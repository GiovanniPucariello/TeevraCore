...
public class DueToRelatedEnumTBeanAccessor implements BeanAccessor<DueToRelatedEnumT> {
	
	private DueToRelatedEnumT bean;
	...
	@Override
	public void setTarget(DueToRelatedEnumT obj) {
		this.bean = obj; 
	}
