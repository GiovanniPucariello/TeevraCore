...
public class UnitofMeasureEnumTBeanAccessor implements BeanAccessor<UnitofMeasureEnumT> {
	
	private UnitofMeasureEnumT bean;
	...
	@Override
	public void setTarget(UnitofMeasureEnumT obj) {
		this.bean = obj; 
	}
