...
import org.fixprotocol.fixml_5_0_sp2.QuoteResponseMessageT;
...
public class QuoteResponseMessageTBeanAccessor implements BeanAccessor<QuoteResponseMessageT> {
	
	private QuoteResponseMessageT bean;
	...
	@Override
	public void setTarget(QuoteResponseMessageT obj) {
		this.bean = obj; 
	}
