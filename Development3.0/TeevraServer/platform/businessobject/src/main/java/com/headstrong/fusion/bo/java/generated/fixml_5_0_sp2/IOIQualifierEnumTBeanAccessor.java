...
public class IOIQualifierEnumTBeanAccessor implements BeanAccessor<IOIQualifierEnumT> {
	
	private IOIQualifierEnumT bean;
	...
	@Override
	public void setTarget(IOIQualifierEnumT obj) {
		this.bean = obj; 
	}
