...
import org.fixprotocol.fixml_5_0.HopGrpBlockT;
...
public class HopGrpBlockTBeanAccessor implements BeanAccessor<HopGrpBlockT> {
	
	private HopGrpBlockT bean;
	...
	@Override
	public void setTarget(HopGrpBlockT obj) {
		this.bean = obj; 
	}
