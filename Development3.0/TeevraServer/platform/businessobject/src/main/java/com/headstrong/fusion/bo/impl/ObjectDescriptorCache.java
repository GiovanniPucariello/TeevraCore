...
public class ObjectDescriptorCache implements Serializable {
	...
	private Map<String, ObjectDescriptor> schemaCache;

	/** Private Constructor */
	private ObjectDescriptorCache() {
		schemaCache = new HashMap<String, ObjectDescriptor>();
	}
	 ...
	 *            schema's descriptor
	 */
	public void addDescriptor(String schemaName, ObjectDescriptor descriptor) {
	 ...
	 * @param schemaName
	 *            name of the schema
	 * @return <code>ObjectDescriptor</code> corresponding to the given schema,
	 *         null if that is not in cache
	 */
	public ObjectDescriptor getDescriptor(String schemaName) {
