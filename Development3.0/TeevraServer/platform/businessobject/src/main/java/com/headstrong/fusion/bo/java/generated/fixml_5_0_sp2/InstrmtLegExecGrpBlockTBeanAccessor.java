...
import org.fixprotocol.fixml_5_0_sp2.InstrmtLegExecGrpBlockT;
...
public class InstrmtLegExecGrpBlockTBeanAccessor implements BeanAccessor<InstrmtLegExecGrpBlockT> {
	
	private InstrmtLegExecGrpBlockT bean;
	...
	@Override
	public void setTarget(InstrmtLegExecGrpBlockT obj) {
		this.bean = obj; 
	}
