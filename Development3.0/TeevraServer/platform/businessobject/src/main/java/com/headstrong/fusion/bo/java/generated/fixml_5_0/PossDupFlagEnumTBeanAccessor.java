...
public class PossDupFlagEnumTBeanAccessor implements BeanAccessor<PossDupFlagEnumT> {
	
	private PossDupFlagEnumT bean;
	...
	@Override
	public void setTarget(PossDupFlagEnumT obj) {
		this.bean = obj; 
	}
