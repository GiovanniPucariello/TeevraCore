 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.headstrong.com/TEEVRA-FIXML-1-0}AllocationReportElements"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{http://www.headstrong.com/TEEVRA-FIXML-1-0}AllocationReportAttributes"/>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    extends AbstractMessageT
{
    ...
    protected List<AllocRptRptSideGrpBlockT> rptSide;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AllocRptRptSideGrpBlockT }
     * 
     * 
     */
    public List<AllocRptRptSideGrpBlockT> getRptSide() {
        if (rptSide == null) {
            rptSide = new ArrayList<AllocRptRptSideGrpBlockT>();
        }
        return this.rptSide;
    }
