...
import org.fixprotocol.fixml_5_0_sp2.BidRequestMessageT;
import org.fixprotocol.fixml_5_0_sp2.MessageHeaderT;
import java.math.BigInteger;
import javax.xml.datatype.XMLGregorianCalendar;
import org.fixprotocol.fixml_5_0_sp2.BidTradeTypeEnumT;
import java.math.BigDecimal;
import org.fixprotocol.fixml_5_0_sp2.BidRequestTransTypeEnumT;
import org.fixprotocol.fixml_5_0_sp2.ExchangeForPhysicalEnumT;
	...
	public void set(String accessPath, Object obj)throws AttributeNotFoundException {
		 if("ccy".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setNumBidders((BigInteger) obj);
			return;
		}
		else if("basisPxTyp".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setNumTkts((BigInteger) obj);
			return;
		}
		else if("outMainCntryUNdx".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setIncTaxInd((BigInteger) obj);
			return;
		}
		else if("strkTm".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setLqdtyIndTyp((BigInteger) obj);
			return;
		}
		else if("encTxtLen".equalsIgnoreCase(accessPath)){
