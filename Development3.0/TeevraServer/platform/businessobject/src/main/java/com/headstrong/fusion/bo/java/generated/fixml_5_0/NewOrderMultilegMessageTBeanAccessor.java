...
import org.fixprotocol.fixml_5_0.NewOrderMultilegMessageT;
...
public class NewOrderMultilegMessageTBeanAccessor implements BeanAccessor<NewOrderMultilegMessageT> {
	
	private NewOrderMultilegMessageT bean;
	...
	public void set(String accessPath, Object obj)throws AttributeNotFoundException {
		 if("maxShow".equalsIgnoreCase(accessPath)){
			...
			this.bean.setMLEGRptTypReq((Integer) obj);
			return;
		}
		else if("complianceID".equalsIgnoreCase(accessPath)){
	...
	@Override
	public void setTarget(NewOrderMultilegMessageT obj) {
		this.bean = obj; 
	}
