...
import org.fixprotocol.fixml_5_0.UndInstrmtGrpBlockT;
...
public class UndInstrmtGrpBlockTBeanAccessor implements BeanAccessor<UndInstrmtGrpBlockT> {
	
	private UndInstrmtGrpBlockT bean;
	...
	@Override
	public void setTarget(UndInstrmtGrpBlockT obj) {
		this.bean = obj; 
	}
