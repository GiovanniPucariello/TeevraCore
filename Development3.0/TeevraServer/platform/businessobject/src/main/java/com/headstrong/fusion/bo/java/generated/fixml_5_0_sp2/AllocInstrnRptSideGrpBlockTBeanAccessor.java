...
import org.fixprotocol.fixml_5_0_sp2.AllocInstrnRptSideGrpBlockT;
...
public class AllocInstrnRptSideGrpBlockTBeanAccessor implements BeanAccessor<AllocInstrnRptSideGrpBlockT> {
	
	private AllocInstrnRptSideGrpBlockT bean;
	...
	@Override
	public void setTarget(AllocInstrnRptSideGrpBlockT obj) {
		this.bean = obj; 
	}
