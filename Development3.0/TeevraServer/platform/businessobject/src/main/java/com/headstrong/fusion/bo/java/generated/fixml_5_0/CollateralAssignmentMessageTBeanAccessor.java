...
import org.fixprotocol.fixml_5_0.CollateralAssignmentMessageT;
...
public class CollateralAssignmentMessageTBeanAccessor implements BeanAccessor<CollateralAssignmentMessageT> {
	
	private CollateralAssignmentMessageT bean;
	...
	public Object get(String accessPath) throws AttributeNotFoundException {
		...
		else if("asgnRsn".equalsIgnoreCase(accessPath)){
	...
	public void set(String accessPath, Object obj)throws AttributeNotFoundException {
		 if("asgnRsn".equalsIgnoreCase(accessPath)){
			this.bean.setAsgnRsn((Integer) obj);
			return;
		}
		else if("setSesID".equalsIgnoreCase(accessPath)){
	...
	@Override
	public void setTarget(CollateralAssignmentMessageT obj) {
		this.bean = obj; 
	}
