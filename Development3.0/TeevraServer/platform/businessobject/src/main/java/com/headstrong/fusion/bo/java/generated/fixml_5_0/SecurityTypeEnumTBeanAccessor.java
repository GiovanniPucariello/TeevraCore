...
public class SecurityTypeEnumTBeanAccessor implements BeanAccessor<SecurityTypeEnumT> {
	
	private SecurityTypeEnumT bean;
	...
	@Override
	public void setTarget(SecurityTypeEnumT obj) {
		this.bean = obj; 
	}
