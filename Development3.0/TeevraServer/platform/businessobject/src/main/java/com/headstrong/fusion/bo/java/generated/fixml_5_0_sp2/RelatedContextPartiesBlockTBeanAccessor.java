...
import org.fixprotocol.fixml_5_0_sp2.RelatedContextPartiesBlockT;
...
public class RelatedContextPartiesBlockTBeanAccessor implements BeanAccessor<RelatedContextPartiesBlockT> {
	
	private RelatedContextPartiesBlockT bean;
	...
	@Override
	public void setTarget(RelatedContextPartiesBlockT obj) {
		this.bean = obj; 
	}
