...
import org.fixprotocol.fixml_5_0_sp2.AdvSideEnumT;
...
public class AdvSideEnumTBeanAccessor implements BeanAccessor<AdvSideEnumT> {
	
	private AdvSideEnumT bean;
	...
	@Override
	public void setTarget(AdvSideEnumT obj) {
		this.bean = obj; 
	}
