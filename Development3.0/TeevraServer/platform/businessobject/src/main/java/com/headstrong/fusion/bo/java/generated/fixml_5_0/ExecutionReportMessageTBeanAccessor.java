...
import org.fixprotocol.fixml_5_0.ExecutionReportMessageT;
import org.fixprotocol.fixml_5_0.PositionEffectEnumT;
import org.fixprotocol.fixml_5_0.PegInstructionsBlockT;
import org.fixprotocol.fixml_5_0.TradedFlatSwitchEnumT;
...
import org.fixprotocol.fixml_5_0.ReportToExchEnumT;
import org.fixprotocol.fixml_5_0.ExecPriceTypeEnumT;
...
import org.fixprotocol.fixml_5_0.CustOrderHandlingInstEnumT;
...
public class ExecutionReportMessageTBeanAccessor implements BeanAccessor<ExecutionReportMessageT> {
	...
	public void set(String accessPath, Object obj)throws AttributeNotFoundException {
		 if("maxShow".equalsIgnoreCase(accessPath)){
			...
			this.bean.setPriInd((Integer) obj);
			return;
		}
		else if("expireDt".equalsIgnoreCase(accessPath)){
			...
			this.bean.setCrssTyp((Integer) obj);
			return;
		}
		else if("avgPx".equalsIgnoreCase(accessPath)){
			...
			this.bean.setLastLqdtyInd((Integer) obj);
			return;
		}
		else if("stat".equalsIgnoreCase(accessPath)){
			...
			this.bean.setTotNumRpts((Integer) obj);
			return;
		}
		else if("trgrInstr".equalsIgnoreCase(accessPath)){
			...
			this.bean.setOrdHndlInstSrc((Integer) obj);
			return;
		}
		else if("listID".equalsIgnoreCase(accessPath)){
