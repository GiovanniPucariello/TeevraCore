...
public class WorkingIndicatorEnumTBeanAccessor implements BeanAccessor<WorkingIndicatorEnumT> {
	
	private WorkingIndicatorEnumT bean;
	...
	@Override
	public void setTarget(WorkingIndicatorEnumT obj) {
		this.bean = obj; 
	}
