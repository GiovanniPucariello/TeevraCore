...
public class SettlSessIDEnumTBeanAccessor implements BeanAccessor<SettlSessIDEnumT> {
	
	private SettlSessIDEnumT bean;
	...
	@Override
	public void setTarget(SettlSessIDEnumT obj) {
		this.bean = obj; 
	}
