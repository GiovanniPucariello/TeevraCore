...
public class InstrumentBlockTBeanAccessor implements BeanAccessor<InstrumentBlockT> {
	...
	public Object get(String accessPath) throws AttributeNotFoundException {
		...
		else if("optPayoutTyp".equalsIgnoreCase(accessPath)){
			return this.bean.getOptPayoutTyp();
		}
		...
		else if("strkPxBndryPrcsn".equalsIgnoreCase(accessPath)){
			return this.bean.getStrkPxBndryPrcsn();
		}
		else if("valMeth".equalsIgnoreCase(accessPath)){
			return this.bean.getValMeth();
		}
		else if("decUndrPrc".equalsIgnoreCase(accessPath)){
			return this.bean.getDecUndrPrc();
		}
		...
		else if("decPrc".equalsIgnoreCase(accessPath)){
			return this.bean.getDecPrc();
		}
		else if("uOM".equalsIgnoreCase(accessPath)){
			return this.bean.getUOM();
		}
		else if("trdUnit".equalsIgnoreCase(accessPath)){
			return this.bean.getTrdUnit();
		}
		else if("cmplxEvnt".equalsIgnoreCase(accessPath)){
			return this.bean.getCmplxEvnt();
		}
		...
		else if("strkPxBndryMeth".equalsIgnoreCase(accessPath)){
			return this.bean.getStrkPxBndryMeth();
		}
		...
		else if("dlyMonCod".equalsIgnoreCase(accessPath)){
			return this.bean.getDlyMonCod();
		}
		else if("repoRt".equalsIgnoreCase(accessPath)){
			return this.bean.getRepoRt();
		}
		else if("strkPxDtrmnMeth".equalsIgnoreCase(accessPath)){
			return this.bean.getStrkPxDtrmnMeth();
		}
		...
		else if("pxDtrmnMeth".equalsIgnoreCase(accessPath)){
			return this.bean.getPxDtrmnMeth();
		}
		else if("asgnMeth".equalsIgnoreCase(accessPath)){
			return this.bean.getAsgnMeth();
		}
		else if("decStrkPrc".equalsIgnoreCase(accessPath)){
			return this.bean.getDecStrkPrc();
		}
	...
	public void set(String accessPath, Object obj)throws AttributeNotFoundException {
		 if("mult".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setOptPayoutTyp((BigInteger) obj);
			return;
		}
		else if("repoTrm".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setStrkPxBndryPrcsn((BigDecimal) obj);
			return;
		}
		else if("valMeth".equalsIgnoreCase(accessPath)){
			if(obj.toString().trim().equals("")){
			...
			return;
			 ...
			 this.bean.setDecUndrPrc((String) obj);
			return;
		}
		else if("rgstry".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setDecPrc((String) obj);
			return;
		}
		else if("uOM".equalsIgnoreCase(accessPath)){
			if(obj.toString().trim().equals("")){
			...
			return;
			 ...
			 this.bean.setTrdUnit((BigDecimal) obj);
			return;
		}
		else if("repoCollSecTyp".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setStrkPxBndryMeth((BigInteger) obj);
			return;
		}
		else if("status".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setDlyMonCod((String) obj);
			return;
		}
		else if("repoRt".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setStrkPxDtrmnMeth((String) obj);
			return;
		}
		else if("snrty".equalsIgnoreCase(accessPath)){
			if(obj.toString().trim().equals("")){
			...
			return;
			 ...
			 this.bean.setSecXML((SecurityXMLBlockT) obj);
			return;
		}
		else if("uOMQty".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setPxDtrmnMeth((BigInteger) obj);
			return;
		}
		else if("asgnMeth".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setDecStrkPrc((String) obj);
			return;
		}
		else if("putCall".equalsIgnoreCase(accessPath)){
