...
public class SettlCurrFxRateCalcEnumTBeanAccessor implements BeanAccessor<SettlCurrFxRateCalcEnumT> {
	
	private SettlCurrFxRateCalcEnumT bean;
	...
	@Override
	public void setTarget(SettlCurrFxRateCalcEnumT obj) {
		this.bean = obj; 
	}
