...
public class ListCancelRequestMessageTBeanAccessor implements BeanAccessor<ListCancelRequestMessageT> {
	
	private ListCancelRequestMessageT bean;
	
	@Override
	public Object get(String accessPath) throws AttributeNotFoundException {
		 if("orignDt".equalsIgnoreCase(accessPath)){
	...
	@Override
	public void setTarget(ListCancelRequestMessageT obj) {
		this.bean = obj; 
	}
