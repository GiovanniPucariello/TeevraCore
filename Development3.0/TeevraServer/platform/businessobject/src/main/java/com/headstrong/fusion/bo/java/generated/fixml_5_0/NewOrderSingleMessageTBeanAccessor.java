...
public class NewOrderSingleMessageTBeanAccessor implements BeanAccessor<NewOrderSingleMessageT> {
	
	private NewOrderSingleMessageT bean;
	...
	@Override
	public void setTarget(NewOrderSingleMessageT obj) {
		this.bean = obj; 
	}
