...
import org.fixprotocol.fixml_5_0_sp2.SecListGrpBlockT;
...
public class SecListGrpBlockTBeanAccessor implements BeanAccessor<SecListGrpBlockT> {
	
	private SecListGrpBlockT bean;
	...
	@Override
	public void setTarget(SecListGrpBlockT obj) {
		this.bean = obj; 
	}
