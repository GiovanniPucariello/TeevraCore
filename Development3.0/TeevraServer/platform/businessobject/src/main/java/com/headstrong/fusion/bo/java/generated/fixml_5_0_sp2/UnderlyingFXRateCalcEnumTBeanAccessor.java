...
public class UnderlyingFXRateCalcEnumTBeanAccessor implements BeanAccessor<UnderlyingFXRateCalcEnumT> {
	
	private UnderlyingFXRateCalcEnumT bean;
	...
	@Override
	public void setTarget(UnderlyingFXRateCalcEnumT obj) {
		this.bean = obj; 
	}
