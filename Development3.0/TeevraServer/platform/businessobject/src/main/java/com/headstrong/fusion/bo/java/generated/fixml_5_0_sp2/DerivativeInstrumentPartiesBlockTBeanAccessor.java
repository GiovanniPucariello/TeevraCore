...
import org.fixprotocol.fixml_5_0_sp2.DerivativeInstrumentPartiesBlockT;
...
public class DerivativeInstrumentPartiesBlockTBeanAccessor implements BeanAccessor<DerivativeInstrumentPartiesBlockT> {
	
	private DerivativeInstrumentPartiesBlockT bean;
	...
	@Override
	public void setTarget(DerivativeInstrumentPartiesBlockT obj) {
		this.bean = obj; 
	}
