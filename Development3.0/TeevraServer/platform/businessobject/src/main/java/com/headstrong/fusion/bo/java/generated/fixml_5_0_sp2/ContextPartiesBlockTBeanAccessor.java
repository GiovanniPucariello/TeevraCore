...
import org.fixprotocol.fixml_5_0_sp2.ContextPartiesBlockT;
...
public class ContextPartiesBlockTBeanAccessor implements BeanAccessor<ContextPartiesBlockT> {
	
	private ContextPartiesBlockT bean;
	...
	@Override
	public void setTarget(ContextPartiesBlockT obj) {
		this.bean = obj; 
	}
