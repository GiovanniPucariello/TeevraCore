...
import org.fixprotocol.fixml_5_0_sp2.NestedParties4BlockT;
...
public class NestedParties4BlockTBeanAccessor implements BeanAccessor<NestedParties4BlockT> {
	
	private NestedParties4BlockT bean;
	...
	@Override
	public void setTarget(NestedParties4BlockT obj) {
		this.bean = obj; 
	}
