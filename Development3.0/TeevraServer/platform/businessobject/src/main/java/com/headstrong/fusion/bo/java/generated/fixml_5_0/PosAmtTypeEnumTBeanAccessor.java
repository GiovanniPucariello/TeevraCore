...
import org.fixprotocol.fixml_5_0.PosAmtTypeEnumT;
...
public class PosAmtTypeEnumTBeanAccessor implements BeanAccessor<PosAmtTypeEnumT> {
	
	private PosAmtTypeEnumT bean;
	...
	@Override
	public void setTarget(PosAmtTypeEnumT obj) {
		this.bean = obj; 
	}
