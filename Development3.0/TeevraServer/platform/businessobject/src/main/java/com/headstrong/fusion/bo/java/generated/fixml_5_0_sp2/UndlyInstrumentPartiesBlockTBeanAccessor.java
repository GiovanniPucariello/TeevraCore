...
import org.fixprotocol.fixml_5_0_sp2.UndlyInstrumentPartiesBlockT;
...
public class UndlyInstrumentPartiesBlockTBeanAccessor implements BeanAccessor<UndlyInstrumentPartiesBlockT> {
	
	private UndlyInstrumentPartiesBlockT bean;
	...
	@Override
	public void setTarget(UndlyInstrumentPartiesBlockT obj) {
		this.bean = obj; 
	}
