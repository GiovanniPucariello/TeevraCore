...
public class FundRenewWaivEnumTBeanAccessor implements BeanAccessor<FundRenewWaivEnumT> {
	
	private FundRenewWaivEnumT bean;
	...
	@Override
	public void setTarget(FundRenewWaivEnumT obj) {
		this.bean = obj; 
	}
