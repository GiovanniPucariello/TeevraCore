...
public class TrdCapRptSideGrpBlockTBeanAccessor implements BeanAccessor<TrdCapRptSideGrpBlockT> {
	...
	public Object get(String accessPath) throws AttributeNotFoundException {
		...
		else if("clAcctRefFrom".equalsIgnoreCase(accessPath)){
			return this.bean.getClAcctRefFrom();
		}
		...
		else if("origClAcctRef".equalsIgnoreCase(accessPath)){
			return this.bean.getOrigClAcctRef();
		}
		...
		else if("origAcct".equalsIgnoreCase(accessPath)){
			return this.bean.getOrigAcct();
		}
		...
		else if("posTyp".equalsIgnoreCase(accessPath)){
			return this.bean.getPosTyp();
		}
		...
		else if("explSettlDt".equalsIgnoreCase(accessPath)){
			return this.bean.getExplSettlDt();
		}
		...
		else if("posRect".equalsIgnoreCase(accessPath)){
			return this.bean.getPosRect();
		}
		...
		else if("acctCodeFrm".equalsIgnoreCase(accessPath)){
			return this.bean.getAcctCodeFrm();
		}
		...
		else if("assgnDt".equalsIgnoreCase(accessPath)){
			return this.bean.getAssgnDt();
		}
		else if("netMny".equalsIgnoreCase(accessPath)){
			return this.bean.getNetMny();
		}
		else if("origOrdID".equalsIgnoreCase(accessPath)){
			return this.bean.getOrigOrdID();
		}
	...
	public void set(String accessPath, Object obj)throws AttributeNotFoundException {
		 if("ccy".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setClAcctRefFrom((String) obj);
			return;
		}
		else if("solFlag".equalsIgnoreCase(accessPath)){
			if(obj.toString().trim().equals("")){
			...
			return;
			 ...
			 this.bean.setOrigClAcctRef((String) obj);
			return;
		}
		else if("inptDev".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setOrigAcct((String) obj);
			return;
		}
		else if("rptID".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setAcctTypFrm((String) obj);
			return;
		}
		else if("posTyp".equalsIgnoreCase(accessPath)){
			 this.bean.setPosTyp((String) obj);
			return;
		}
		else if("rptSeq".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setExplSettlDt((String) obj);
			return;
		}
		else if("allocID".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setPosRect((String) obj);
			return;
		}
		else if("exDt".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setAcctCodeFrm((String) obj);
			return;
		}
		else if("oddLot".equalsIgnoreCase(accessPath)){
			if(obj.toString().trim().equals("")){
			...
			return;
			 ...
			 this.bean.setAssgnDt((XMLGregorianCalendar) obj);
			return;
		}
		else if("netMny".equalsIgnoreCase(accessPath)){
			...
			return;
			 ...
			 this.bean.setOrigOrdID((String) obj);
			return;
		}
		else if("feeDistribution".equalsIgnoreCase(accessPath)){
