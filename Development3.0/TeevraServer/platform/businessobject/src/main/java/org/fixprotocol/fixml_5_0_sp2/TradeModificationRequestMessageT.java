...
/**
 * TradeModificationRequest is a mock of AllocationInstruction created for Business reasons  and can be found in Volume5 of the specification 
 * 
 * <p>Java class for TradeModificationRequest_message_t complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TradeModificationRequest_message_t">
 *   &lt;complexContent>
...
@XmlType(name = "TradeModificationRequest_message_t", propOrder = {
    "ordAlloc",
    "allExc",
    "instrmt",
    "instrmtExt",
...
public class TradeModificationRequestMessageT
