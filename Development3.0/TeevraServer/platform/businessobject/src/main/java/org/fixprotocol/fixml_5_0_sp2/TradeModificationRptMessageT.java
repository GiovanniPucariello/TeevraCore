...
/**
 * TradeModificationRpt is a mock of AllocationReport and can be found in Volume5 of the specification 
 * 
 * <p>Java class for TradeModificationRpt_message_t complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TradeModificationRpt_message_t">
 *   &lt;complexContent>
...
@XmlType(name = "TradeModificationRpt_message_t", propOrder = {
    "ordAlloc",
    "allExc",
    "instrmt",
    "instrmtExt",
...
public class TradeModificationRptMessageT
