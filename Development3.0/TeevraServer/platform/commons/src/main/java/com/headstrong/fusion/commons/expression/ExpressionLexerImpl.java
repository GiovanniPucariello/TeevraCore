// $ANTLR 2.7.7 (2006-11-01): "E:/Projects/eclipse workspaces/testing/antrlJava/src/com/antlr/expression.g" -> "ExpressionLexerImpl.java"$
...
public class ExpressionLexerImpl extends antlr.CharScanner implements ExpressionParserImplTokenTypes, TokenStream
 {
public ExpressionLexerImpl(InputStream in) {
	this(new ByteBuffer(in));
}
public ExpressionLexerImpl(Reader in) {
	this(new CharBuffer(in));
}
public ExpressionLexerImpl(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public ExpressionLexerImpl(LexerSharedInputState state) {
	super(state);
...
tryAgain:
			...
			try {   // for lexical error handling
				...
				default:
					if ((LA(1)=='"') && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff'))) {
						...
						mGREATERTHANEQUALTO(true);
						theRetToken=_returnToken;
					}
					else if ((LA(1)=='<') && (LA(2)=='=')) {
						mLESSTHANEQUALTO(true);
						theRetToken=_returnToken;
					}
					else if ((LA(1)=='"') && (true)) {
						mDOUBLEQUOTE(true);
	...
	public final void mBOIDENTIFIER(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = BOIDENTIFIER;
		int _saveIndex;
	...
	public final void mARITHBOIDENTIFIER(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = ARITHBOIDENTIFIER;
		int _saveIndex;
...
inputState.guessing--;
	...
	protected final void mOCTAL_LITERAL(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = OCTAL_LITERAL;
		int _saveIndex;
	...
	protected final void mXx(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = Xx;
		int _saveIndex;
	...
	public final void mGREATERTHANEQUALTO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = GREATERTHANEQUALTO;
		int _saveIndex;
	...
	public final void mLESSTHANEQUALTO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = LESSTHANEQUALTO;
		int _saveIndex;
