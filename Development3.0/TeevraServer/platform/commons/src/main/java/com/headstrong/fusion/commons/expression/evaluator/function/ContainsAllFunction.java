 ...
 * contains all remaining arguments, in any order.
 * </p>
 * 
 * <p>
 * Usage: containsAll(a:array or list, element1, element2, ... elementN)
 * </p>
 * 
 * <p>
 ...
 * 
 */
public class ContainsAllFunction extends StandardFunction {
	public Object call(EvaluationContext ec, String functionName, Object[] args)
		...
		if (null == haystack) {
			if (Boolean.FALSE.equals(ec
				...
				return Boolean.FALSE; // Cannot containAll
			else
