...
/**
 * <code>RuleManager is the interface that needs to be implemented by the rulemanager who can manage the rules and their objects. 
 */
public interface RuleManager {
	 ...
	 * @return
	 * 		Data returned by the rule. 
	 * @throws RuleNotFoundException
	 * 		If the rule could not be found. 
	 * @throws RuleOperationFailedException 
	 * 		If the rule fails on operate on the data provided. 
	 */
	Object executeRule(String aliasName,Map<String, Object> data) throws RuleNotFoundException, RuleOperationFailedException;
