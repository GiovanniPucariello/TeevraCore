...
package com.headstrong.fusion.connector.tfp.processor;

import com.headstrong.fusion.commons.exception.FusionException;
import com.headstrong.fusion.connector.tfp.splitter.FileSplitter;
...
public interface FileSplitterProcessor {
	...
	/**
	 * Processes the message. recordStartPattern is provided if the already split
