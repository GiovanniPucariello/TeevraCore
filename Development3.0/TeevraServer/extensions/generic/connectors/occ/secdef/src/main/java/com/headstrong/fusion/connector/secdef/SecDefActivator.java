 ...
 * 
 */
public class SecDefActivator implements BundleActivator {
	...
	public void start(BundleContext arg0) throws Exception {
		SecDefComponent condDBComponent = new SecDefComponent();
		FusionComponentFactory.addComponent(SecDefComponent.class
