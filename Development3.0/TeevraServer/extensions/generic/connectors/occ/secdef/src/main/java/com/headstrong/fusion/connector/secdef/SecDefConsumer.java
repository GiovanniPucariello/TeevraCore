 ...
 * 
 */
public class SecDefConsumer implements FusionConsumer<MessageExchange> {
	
	FusionServiceSupport serviceSupport;
	
	private SecDefEndpoint conDBEndpoint;
	public SecDefConsumer(SecDefEndpoint conditionaldbEndpoint) {
