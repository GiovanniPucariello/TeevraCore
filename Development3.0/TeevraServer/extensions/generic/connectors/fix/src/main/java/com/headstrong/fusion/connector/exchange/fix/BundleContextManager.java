...
public class BundleContextManager {
	 ...
	 * 
	 * @return {@link BundleContextManager}
	 */
	...
	public static void init(BundleContext bundleContext) {
		logger.info("Initiallizing TEDI BundlecontextManager");
		BundleContextManager.contextManager = new BundleContextManager(
				bundleContext);
	}
	...
	public static void destroy() {
		BundleContextManager.contextManager = null;
	}
}
