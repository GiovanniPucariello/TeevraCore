...
/**
 * Default implementation of static data factory.
 * 
 */
public class DefaultStaticDataFactory extends StaticDataFactory {

	static Connection con = null;
	static List<String> listOfSheets = new ArrayList<String>();

	public DefaultStaticDataFactory(Properties p) {
		initConnection(p);
	}
	...
	public List<String> getMessageName() {
		...
		try {
			...
			throw new DataException(
					"Could not obtain a connection.. terminating.", e);
		}
		return listOfSheets;
	}
	...
	private void initConnection(Properties props) {
		...
		try {
			...
			throw new RuntimeException(
					"Could not obtain a driver.. terminating.", e1);
		}
		try {
